...
import originImg from '@/assets/imgs/origin.png'
...
<table style="text-align: center;width: 100%;">
  ...
  <tr>
    <td><Image src={originImg} alt="origin" style="zoom: 50%; object-fit: contain" /></td>
    <td><Image src={watermarkImg} alt="watermark" style="zoom: 67%; object-fit: contain" /></td>
    <td><Image src={targetImg} alt="target" style="zoom: 50%; object-fit: contain" /></td>
  </tr>
</table>
