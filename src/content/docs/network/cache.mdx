...
import strongCache from '@/assets/imgs/strong-cache.png'
import strongCacheEffect from '@/assets/imgs/strong-cache-effect.png'
import conditionalCache from '@/assets/imgs/conditional-cache.png'
import conditionalCacheHeaders from '@/assets/imgs/conditional-cache-headers.png'
import conditionalCacheStatus from '@/assets/imgs/conditional-cache-status.png'
...
<Image src={strongCache} alt="strong-cache" />
...
<Image src={strongCacheEffect} alt="strong-cache-effect" />
...
<Image src={conditionalCache} alt="conditional-cache" />
...
<Image src={conditionalCacheStatus} alt="conditional-cache-status" />

以下是本次请求的请求头与响应头信息：

<Image src={conditionalCacheHeaders} alt="conditional-cache-headers" />
